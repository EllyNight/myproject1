...
def apply_custom_css():
    st.markdown("""
        ...
        .info-card {
            ...
            border-top: 5px solid #007FA8; /* 스카이 블루 포인트 */
            margin-bottom: 20px;
        }
        .info-card h4 {
            color: #002C5F;
    ...
    if page == "🏠 메인 개요 (Home)":
        ...
        with col1:
            ...
            <div class="info-card">
                ...
                연도별 차량 등록 증감 추이를 꺾은선 그래프로 파악하고, 차종/용도별 상세 등록 대수를 상하위 계층별로 정확하게 비교할 수 있는 동적 인터랙티브 차트를 제공합니다.</p>
        ...
        with col2:
            ...
            <div class="info-card">
                ...
                <p>현대자동차와 기아의 공식 웹사이트에서 실시간으로 수집된 방대한 고객지원(FAQ) 데이터를 기반으로 합니다.<br>
        ...
        try:
            ...
            if not df_companies.empty and 'company' in df_companies.columns:
                ...
                if selected_company != "기업을 선택하세요":
                    ...
                    # 2번째 드롭다운(대분류)까지만 선택하면 바로 전체 FAQ 목록 출력
